...
import com.example.test.dto.response.IntrospectTokenResponse;
import com.example.test.dto.response.httpClient.ExchangeTokenFacebookResponse;
import com.example.test.dto.response.httpClient.ExchangeTokenGoogleResponse;
import com.example.test.entity.InvalidatedToken;
import com.example.test.entity.Role;
import com.example.test.entity.User;
import com.example.test.enums.AuthProvider;
...
import com.example.test.repository.httpClient.OutboundIdentityClientFacebook;
import com.example.test.repository.httpClient.OutboundIdentityClientGoogle;
import com.example.test.repository.httpClient.OutboundUserFacebookClient;
import com.example.test.repository.httpClient.OutboundUserGoogleClient;
